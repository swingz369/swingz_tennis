  ...
  'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-brandSecondary/10 text-brandSecondary border border-brandSecondary/20',
        accent: 'bg-brandAccent/10 text-brandAccent border border-brandAccent/20',
...
const ProfessionalBadge = React.forwardRef<HTMLDivElement, ProfessionalBadgeProps>(
