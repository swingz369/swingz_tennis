 ...
 *
 * Ausführung:
 *   npx vitest run tests/browser/design-preview-badges.test.ts
 */
...
describe('Design Preview — Badge Variants', () => {
  ...
  it(
    'should open the Badges tab and show all 3 size headings',
    async () => {
  ...
  it(
    'should render each of the 8 badge variants with correct labels',
    async () => {
  ...
  it(
    'should render badges in all 3 sizes with correct CSS classes',
    async () => {
