...
export const sessions = pgTable(
  'sessions',
  {
    ...
    timeslot_start: timestamp('timeslot_start', { withTimezone: true }).notNull(),
    timeslot_end: timestamp('timeslot_end', { withTimezone: true }).notNull(),
...
export const billingPeriods = pgTable(
  ...
  (table) => ({
    ...
    club_idx: index('billing_periods_club_idx').on(table.club_id),
  })
);
