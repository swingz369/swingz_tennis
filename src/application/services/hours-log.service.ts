  ...
  static initializeMockData(): void {
    ...
    this.hoursLogs = [
      ...
      },
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(-1),
        notes: 'Trainingsvorbereitung Wochenplan',
        createdAt: d(-2),
        updatedAt: d(-1),
      },
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(-2),
        notes: 'Team-Meeting Saisonplanung',
        createdAt: d(-3),
        updatedAt: d(-2),
      },
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(-3),
        notes: 'Überstunden — nicht genehmigt',
        createdAt: d(-4),
        updatedAt: d(-3),
      },
      // --- Trainer 2: Julia Weber (approved + pending) ---
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(0, -1),
        notes: 'Probetraining — sehr erfolgreich',
        createdAt: d(-1),
        updatedAt: d(0, -1),
      },
      {
      ...
      },
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(-2),
        notes: 'Videoanalyse Vorbereitung',
        createdAt: d(-3),
        updatedAt: d(-2),
      },
      {
        ...
        type: 'meeting',
        status: 'pending',
        notes: 'Elternabend Jugendtraining',
        createdAt: d(-5),
        updatedAt: d(-5),
      },
      ...
      },
      {
        ...
        type: 'preparation',
        status: 'pending',
        notes: 'Materialvorbereitung Jugendcamp',
        createdAt: d(-2),
        updatedAt: d(-2),
      },
      ...
      },
      {
        ...
        type: 'meeting',
        status: 'pending',
        notes: 'Feedbackgespräch Mitglieder',
        createdAt: d(-3),
        updatedAt: d(-3),
      },
      {
        ...
        approvedBy: 'Admin',
        approvedAt: d(-5),
        notes: 'Turniervorbereitung Vereinsmeisterschaft',
        createdAt: d(-6),
        updatedAt: d(-5),
      },
    ];
    ...
    this.attendanceRecords = [
      ...
      },
      {
        ...
        participantName: 'Felix Hoffmann',
        date: today,
        status: 'present',
        checkInTime: '13:55',
        checkOutTime: '15:35',
      ...
      },
      {
        ...
        participantName: 'Laura Becker',
        date: today,
        status: 'absent',
        notes: 'Krank gemeldet',
        createdAt: d(-1),
        updatedAt: d(-1),
      },
      {
      ...
      },
      {
        ...
        trainerId: 'trainer-2',
        trainerName: 'Julia Weber',
        participantId: 'member-8',
        participantName: 'Nina Schwarz',
        date: today,
        status: 'present',
        checkInTime: '14:55',
        checkOutTime: '16:05',
      ...
      },
      {
        ...
        trainerId: 'trainer-2',
        trainerName: 'Julia Weber',
        participantId: 'member-10',
        participantName: 'Julia König',
        date: pastDate(1),
        status: 'present',
        checkInTime: '09:50',
        checkOutTime: '12:05',
      ...
      },
      {
        ...
        trainerId: 'trainer-3',
        trainerName: 'David Kruse',
        participantId: 'member-7',
        participantName: 'Lukas Fischer',
        date: today,
        status: 'present',
        checkInTime: '07:50',
        checkOutTime: '09:05',
      ...
      },
      {
        ...
        trainerId: 'trainer-3',
        trainerName: 'David Kruse',
        participantId: 'member-12',
        participantName: 'Elena Wolf',
        date: today,
        status: 'late',
        checkInTime: '08:20',
        checkOutTime: '09:05',
        notes: '20 Min verspätet — Zugausfall',
        createdAt: d(-1),
        updatedAt: d(-1),
      },
      {
        ...
        trainerId: 'trainer-4',
        trainerName: 'Sabine Frost',
        participantId: 'member-20',
        participantName: 'Birgit Vogel',
        date: today,
        status: 'present',
        checkInTime: '10:50',
        checkOutTime: '12:05',
