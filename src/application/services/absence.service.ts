  ...
  static initializeMockData(): void {
    ...
    this.absences = [
      ...
      },
      {
        ...
        endDate: ds(32),
        status: 'approved',
        reason: 'DTB Fortbildung München',
        approvedBy: 'Admin',
        approvedAt: dsa(0),
        createdAt: dsa(1),
        updatedAt: dsa(0),
      ...
      },
      {
        ...
        endDate: ds(65),
        status: 'pending',
        reason: 'Turnierteilnahme Berlin',
        notes: 'Eventuell Vertretung durch Julia Weber',
        createdAt: dsa(0),
        updatedAt: dsa(0),
      },
      {
