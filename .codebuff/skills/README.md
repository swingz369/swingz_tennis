...
| [**swingz-drizzle-migrations**](./swingz-drizzle-migrations/SKILL.md)     | Drizzle 2-schema split (auth + public), JSONB columns, migration workflow | You mention: drizzle migration, schema.ts, JSONB, jsonb, alter table, ADD COLUMN, supabase/migrations  |
| [**swingz-vitest-bench**](./swingz-vitest-bench/SKILL.md)                 | vi.hoisted mock-state for Drizzle, 3-config bench, JSON report, CI perf   | You mention: vitest bench, benchmark, vi.hoisted, perf-bench, scaling, regression, .bench-results.json |
