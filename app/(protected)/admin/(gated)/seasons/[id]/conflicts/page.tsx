  ...
  const handleAction = async (conflictId: string, action: 'resolve' | 'ignore') => {
    ...
    try {
      ...
      setData((prev) => {
        ...
        ) as ConflictDetectionResult['status'];
            ...
            <Card key={key}>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {count === 0
                    ? 'Keine'
                    : `${count} ${key === 'info' ? '' : 'offene'} ${key === 'info' ? 'Hinweise' : 'Konflikte'}`}
                </p>
              </CardContent>
            </Card>
          );
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Die Planung ist konfliktfrei. Klicke &quot;Neu laden&quot; um eine erneute Prüfung
                durchzuführen.
              </p>
            </CardContent>
          </Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      {conflict.timeSlot && (
                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span>
                            {DAY_LABELS[conflict.timeSlot.dayOfWeek - 1] ||
                              `Tag ${conflict.timeSlot.dayOfWeek}`}
              ...
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Badge
                    variant="outline"
                    className={
                      conflict.status === 'resolved' ? 'text-success-600' : 'text-muted-foreground'
                    }
                  >
