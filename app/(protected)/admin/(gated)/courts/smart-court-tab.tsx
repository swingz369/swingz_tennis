      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            verwendet wird. Club-Level-Settings — alle Plätze dieses Vereins nutzen denselben
            Vendor.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className={isSelected ? 'text-brand-primary' : 'text-muted-foreground'}>
                        {meta.icon}
                      </span>
          ...
          <div className="flex items-center justify-between border-t pt-4">
            <p className="text-xs text-muted-foreground">
              ...
              {didVendorChange && (
                <span className="ml-2 text-brand-primary">(noch nicht gespeichert)</span>
              )}
            </p>
            <Button
              onClick={handleSave}
