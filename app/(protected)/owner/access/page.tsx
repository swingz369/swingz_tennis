              ...
              return (
                <div key={r.id} className="py-4 flex items-start justify-between gap-4">
                  <div className="space-y-1 min-w-0">
                    ...
                    <a
                      href={`mailto:${r.email}`}
                      className="flex items-center gap-1 text-xs text-info-600 hover:underline"
                    >
                      ...
                      <div className="flex gap-1.5 mt-1">
                        <form action={updateStatus.bind(null, r.id, 'approved')}>
                          <Button
                            size="sm"
                            variant="outline"
                            className="h-7 gap-1 text-success-700 border-success-300 hover:bg-success-50 dark:hover:bg-success-900/20"
                          >
                        ...
                        <form action={updateStatus.bind(null, r.id, 'rejected')}>
                          <Button
                            size="sm"
                            variant="outline"
                            className="h-7 gap-1 text-error-700 border-error-300 hover:bg-error-50 dark:hover:bg-error-900/20"
                          >
