    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        >
          ...
          {cartCount > 0 && (
            <span className="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-primary text-2xs font-bold text-white shadow-sm">
              {cartCount}
            </span>
          )}
        </Button>
      ...
      <div className="flex gap-2 flex-wrap">
        {categories.map((c) => (
          <Button
            ...
            className={category === c ? 'bg-primary hover:bg-primary/90' : ''}
          >
            {c === 'all' ? 'Alle' : c}
          </Button>
        ))}
