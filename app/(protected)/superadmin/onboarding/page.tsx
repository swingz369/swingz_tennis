                ...
                {stepNum < TOTAL_STEPS && (
                  <div
                    className={`absolute top-5 left-full h-0.5 w-[calc(100%+0.5rem)] -translate-y-1/2 transition-colors duration-500 ${
                      isCompleted ? 'bg-info-600 dark:bg-info-500' : 'bg-muted'
                    }`}
                  />
                )}
                <div
                  className={`relative z-10 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                    isCompleted
                      ? 'bg-info-600 dark:bg-info-500 text-white shadow-md shadow-info-600/20'
                      : isCurrent
                        ? 'bg-info-600 dark:bg-info-500 text-white ring-4 ring-info-600/20 shadow-lg shadow-info-600/30 scale-110'
      ...
      case 1:
        return (
          <div className="text-center space-y-8 py-6">
            ...
            <Button
              size="lg"
              className="bg-info-600 hover:bg-info-700 text-white px-8 shadow-lg shadow-info-600/20"
              onClick={() => setStep(2)}
            >
              Los geht&apos;s
                ...
                <div className="flex items-center justify-between pt-6 mt-6 border-t">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      onClick={goNext}
                      disabled={loading}
                      className="bg-info-600 hover:bg-info-700 text-white shadow-md shadow-info-600/10"
                    >
                      {loading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                      Weiter
