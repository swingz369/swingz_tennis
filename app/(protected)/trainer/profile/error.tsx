  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="w-full max-w-lg text-center space-y-4 p-6">
        <div className="mx-auto h-14 w-14 rounded-2xl bg-error-50 dark:bg-error-900/20 flex items-center justify-center">
        ...
        <div className="rounded-lg bg-error-50 dark:bg-error-900/10 border border-error-200 dark:border-error-800 p-3 text-xs text-error-600 dark:text-error-400 break-all">
          {error.message}
        </div>
