...
const typographySizes = [
  ...
  { name: 'Display 4', class: 'text-display-4', text: 'The Quick Brown Fox' },
  {
    name: 'Body XL',
    class: 'text-xl',
    text: 'Premium Tennis Club Management für anspruchsvolle Vereine.',
  },
  {
    name: 'Body LG',
    class: 'text-lg',
    ...
    <div className="min-h-screen bg-muted/50 dark:bg-[#0a120e]">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#0A3D2E] via-[#1B4332] to-[#2D6A4F]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 text-center">
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto">
            ...
            SwingZ Premium Tennis Club Management Systems.
          </p>
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 space-y-16">
        ...
        {activeTab === 'colors' && (
          <Section
            title="Brand Colors"
            description="Primäre Farbskala des SwingZ-Design-Systems. Alle Werte als HSL-CSS-Variablen definiert."
          >
        ...
        {activeTab === 'typography' && (
          <Section
            title="Typografie"
            description="Clash Display für Überschriften, DM Sans für Fließtext. Hierarchy von Hero XL bis Overline."
          >
        ...
        {activeTab === 'shadows' && (
          <Section
            title="Schatten"
            description="Vier Hierarchiestufen (soft → premium) plus Akzent-Glow-Varianten für Buttons und Cards."
          >
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                {(
                  ['shadow-card-default', 'shadow-card-hover', 'shadow-card-elevated'] as const
                ).map((s) => (
                  <div
                    key={s}
                    className={cn(
        ...
        {activeTab === 'radius' && (
          <Section
            title="Border Radius"
            description="Einheitliche Radius-Skala von none (0) bis full (9999px). Verwendet in Cards, Buttons, Inputs und Modals."
          >
            <div className="grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-9 gap-4">
              {radii.map((r) => (
                <div key={r.name} className="space-y-2">
                  <div
                    className={cn(
                      'h-20 bg-gradient-to-br from-brand-light to-brand-primary',
                      r.class
                    )}
                  />
                  <div className="text-center">
        ...
        {activeTab === 'animations' && (
          <Section
            title="Animationen"
            description="Acht Keyframe-Animationen mit dazugehörigen CSS-Klassen. Respektieren prefers-reduced-motion."
          >
              ...
              {animations.map((anim) => (
                ...
                >
                  <div
                    key={animKey}
                    className={cn(
                      'w-12 h-12 mx-auto rounded-xl bg-gradient-to-br from-brand-light to-brand-primary flex items-center justify-center shadow-lg mb-3',
                      anim.class
                    )}
                  >
        ...
        {activeTab === 'spacing' && (
          <Section
            title="Abstände"
            description="4px/8px/16px/24px/32px-Raster für konsistente Layouts. Basis aller Spacing-Entscheidungen."
          >
                  ...
                  <div key={g} className="flex flex-col items-center gap-1">
                    <div className="flex gap-1">
                      {[...Array(3)].map((_, i) => (
                        <div
                          key={i}
                          className="w-6 h-6 rounded bg-brand-light/20 dark:bg-brand-light/10"
                        />
                      ))}
                    </div>
                    <span className="text-2xs font-mono text-muted-foreground dark:text-muted-foreground">
