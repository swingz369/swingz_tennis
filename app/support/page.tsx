...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Sende eine E-Mail an datenschutz@mail.swingz.cloud mit dem Betreff „Account-Löschung". Wir löschen deine Daten innerhalb von 30 Tagen gemäß DSGVO.',
    href: 'mailto:datenschutz@mail.swingz.cloud',
    cta: 'E-Mail senden',
  },
  {
    q: 'Wie kontaktiere ich den Support?',
    a: 'Du erreichst unser Support-Team per E-Mail unter support@mail.swingz.cloud oder über das Kontaktformular. Wir antworten innerhalb von 24 Stunden an Werktagen.',
    href: '/contact',
...
const CHANNELS = [
  {
    ...
    title: 'E-Mail',
    description: 'support@mail.swingz.cloud',
    note: 'Antwort innerhalb von 24h (Werktage)',
    href: 'mailto:support@mail.swingz.cloud',
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <ResourceCard
              ...
              href="mailto:bugs@mail.swingz.cloud"
