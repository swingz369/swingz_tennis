...
export async function POST(request: NextRequest) {
  // allowWhilePastDue: this route is how a blocked admin/superadmin FIXES
  // their payment (new subscription or plan switch) — it must stay reachable
  // even though lib/api-auth.ts's dunning gate otherwise blocks writes.
  return withApiAuth(
    request,
    async (auth) => {
