...
function convertToCSV(statistics: any): string {
  const rows = [
    ...
    ['Durchschnittlicher Umsatz pro Mitglied (€)', statistics.revenueStats.averageRevenuePerMember.toFixed(2)],
    ...
    ['Durchschnittliche Stunden pro Trainer', statistics.trainerStats.averageHoursPerTrainer.toFixed(2)],
    ['Gesamtsitzungen', statistics.trainerStats.totalSessions],
    ['Durchschnittliche Sitzungen pro Trainer', statistics.trainerStats.averageSessionsPerTrainer.toFixed(2)],
  ];
