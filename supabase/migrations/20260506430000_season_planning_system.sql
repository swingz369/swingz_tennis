...
DROP POLICY IF EXISTS "Users can view seasons of their club" ON seasons;
...
DROP POLICY IF EXISTS "Admins can manage seasons of their club" ON seasons;
...
DROP POLICY IF EXISTS "Users can view own preferences" ON user_training_preferences;
CREATE POLICY "Users can view own preferences" ON user_training_preferences
    FOR SELECT USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Admins can view all preferences in club" ON user_training_preferences;
...
DROP POLICY IF EXISTS "Users can view plan entries of their club" ON season_plan_entries;
...
DROP POLICY IF EXISTS "Admins can manage plan entries of their club" ON season_plan_entries;
...
DROP POLICY IF EXISTS "Users can view conflicts of their club" ON planning_conflicts;
...
DROP POLICY IF EXISTS "Admins can manage conflicts of their club" ON planning_conflicts;
...
DROP POLICY IF EXISTS "Users can view planning history of their club" ON season_planning_history;
...
DROP POLICY IF EXISTS "Admins can insert planning history" ON season_planning_history;
