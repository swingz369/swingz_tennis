...
-- ═══════════════════════════════════════════════════════════════
-- 15. trainer_availability.user_id → public.users(id)
-- ═══════════════════════════════════════════════════════════════
ALTER TABLE public.trainer_availability DROP CONSTRAINT IF EXISTS trainer_availability_user_id_fkey;
ALTER TABLE public.trainer_availability ADD CONSTRAINT trainer_availability_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
