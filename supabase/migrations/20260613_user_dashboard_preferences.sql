...
CREATE INDEX idx_dashboard_prefs_type ON user_dashboard_preferences(dashboard_type);
CREATE INDEX idx_dashboard_prefs_club ON user_dashboard_preferences(club_id);
