...
CREATE INDEX trainer_slot_waitlist_slot_idx ON trainer_slot_waitlist (slot_id);
CREATE INDEX trainer_slot_waitlist_user_idx ON trainer_slot_waitlist (user_id);
