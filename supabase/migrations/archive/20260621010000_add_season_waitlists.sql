...
DROP POLICY IF EXISTS "Admins can manage season_waitlists" ON public.season_waitlists;
...
DROP POLICY IF EXISTS "Members can view own waitlist entries" ON public.season_waitlists;
