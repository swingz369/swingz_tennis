...
DROP POLICY IF EXISTS "club members can read documents" ON club_documents;
...
DROP POLICY IF EXISTS "admins can manage documents" ON club_documents;
...
DROP POLICY IF EXISTS "club members can read maintenance" ON court_maintenance;
...
DROP POLICY IF EXISTS "admins can manage maintenance" ON court_maintenance;
...
DROP POLICY IF EXISTS "club members can read meetings" ON member_meetings;
...
DROP POLICY IF EXISTS "admins can manage meetings" ON member_meetings;
