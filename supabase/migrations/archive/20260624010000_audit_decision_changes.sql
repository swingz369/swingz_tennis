...
DROP POLICY IF EXISTS decision_changes_club_read ON public.decision_changes;
...
DROP POLICY IF EXISTS decision_changes_admin_insert ON public.decision_changes;
