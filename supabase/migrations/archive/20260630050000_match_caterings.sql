...
create table if not exists match_caterings (
...
DROP POLICY IF EXISTS "admin manage match_caterings" ON match_caterings;
...
DROP POLICY IF EXISTS "member read match_caterings" ON match_caterings;
