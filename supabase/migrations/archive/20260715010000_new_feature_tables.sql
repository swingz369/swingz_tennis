...
DROP POLICY IF EXISTS court_closures_select ON public.court_closures;
...
DROP POLICY IF EXISTS court_closures_insert ON public.court_closures;
...
DROP POLICY IF EXISTS court_closures_update ON public.court_closures;
...
DROP POLICY IF EXISTS court_closures_delete ON public.court_closures;
...
DROP POLICY IF EXISTS work_duties_select ON public.work_duties;
...
DROP POLICY IF EXISTS work_duties_insert ON public.work_duties;
...
DROP POLICY IF EXISTS work_duties_update ON public.work_duties;
...
DROP POLICY IF EXISTS work_duties_delete ON public.work_duties;
...
DROP POLICY IF EXISTS work_duty_assignments_select ON public.work_duty_assignments;
...
DROP POLICY IF EXISTS work_duty_assignments_insert ON public.work_duty_assignments;
...
DROP POLICY IF EXISTS work_duty_assignments_update ON public.work_duty_assignments;
...
DROP POLICY IF EXISTS work_duty_assignments_delete ON public.work_duty_assignments;
