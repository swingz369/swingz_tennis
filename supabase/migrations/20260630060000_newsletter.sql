...
DROP POLICY IF EXISTS "admin manage newsletter_campaigns" ON newsletter_campaigns;
...
DROP POLICY IF EXISTS "admin read newsletter_send_logs" ON newsletter_send_logs;
...
DROP POLICY IF EXISTS "service role insert newsletter_send_logs" ON newsletter_send_logs;
