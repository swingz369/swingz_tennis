 ...
 *
 * Ausführung:
 *   npx vitest run e2e/design-preview-iconbox.test.ts
 */
...
describe('Design Preview — IconBox Variants', () => {
  ...
  it('should open the IconBox tab and show all 4 size headings', async () => {
  ...
  it('should render each of the 14 IconBox variants with correct labels', async () => {
  ...
  it('should render IconBox containers in all 4 sizes', async () => {
  ...
  it('should render each IconBox with an svg icon inside', async () => {
